...
public class ActivityAidlJanken extends AppCompatActivity {

    // IAIDLSampleServiceのインスタンス
    private IAIDLJankenService aidlJankenServiceIf;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aidl_janken);
        ...
        // UIパーツ取得
        btnGu = findViewById(R.id.imgBtnGu);
        btnChoki = findViewById(R.id.imgBtnChoki);
        btnPa = findViewById(R.id.imgBtnPa);
        myHandView = (TextView) findViewById(R.id.txtvMyHand);
        enmHandView = (TextView) findViewById(R.id.txtvComHand);
        resultView = (TextView) findViewById(R.id.txtvWin_Loss);
    ...
    private ServiceConnection aidlJankenServiceConn = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            // サービスのインターフェースを取得する
            aidlJankenServiceIf = IAIDLJankenService.Stub.asInterface(service);
